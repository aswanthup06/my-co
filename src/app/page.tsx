    ...
    <div className=" scroll-smooth">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center container mx-auto px-4 md:px-6 lg:px-20 mt-24">
        <div className="text-gray-800 flex flex-col items-center md:items-start text-center md:text-left">
          <h1 className="text-6xl font-bold mb-1 text-gray-900 mt-10 ">
            Digital Products
          </h1>
          <h1 className="text-5xl font-semibold mb-4 text-amber-600">
            Creator Agency
          </h1>
          <p className="text-lg mb-6 text-gray-600 leading-relaxed max-w-lg">
          ...
          <button className="flex w-fit bg-amber-600 hover:bg-amber-700 duration-500 text-white items-center px-6 py-3 rounded-full gap-2 transition-colors border-2 hover:border-2 hover:border-amber-800 cursor-pointer">
      ...
      <div className="container mx-auto md:px-6 lg:px-20 py-12 text-center">
      ...
      <div className="container mx-auto md:px-6 lg:px-20 mt-8">
